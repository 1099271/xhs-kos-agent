...
class LlamaIndexManager:
    ...
    def _init_storage_context(self):
        ...
        for storage_dir in [self.comment_storage_dir, self.note_storage_dir, self.analysis_storage_dir]:
...
"""
            ...
            # 持久化索引
            self.comment_index.storage_context.persist(persist_dir=str(self.comment_storage_dir))
...
"""
                ...
                doc = Document(
                    ...
                    metadata={
                        ...
                        "created_at": str(note.created_at) if hasattr(note, 'created_at') else 'N/A',
                        "type": "note"
                    }
                )
                documents.append(doc)
            ...
            # 持久化索引
            self.note_index.storage_context.persist(persist_dir=str(self.note_storage_dir))
...
"""
            ...
            # 持久化索引
            self.analysis_index.storage_context.persist(persist_dir=str(self.analysis_storage_dir))
